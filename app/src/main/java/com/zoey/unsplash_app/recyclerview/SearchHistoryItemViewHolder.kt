...
class SearchHistoryItemViewHolder(itemView: View, searchRecyclerViewInterface: ISearchHistoryRecyclerView) :
    ...
    init {
        ...
        mySearchRecyclerViewInterface = searchRecyclerViewInterface
    }
